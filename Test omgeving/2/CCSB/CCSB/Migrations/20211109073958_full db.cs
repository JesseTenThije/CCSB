        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CrvName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    CrvPlate = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reserveringen_CrvId",
                table: "Reserveringen",
                column: "CrvId");

            migrationBuilder.AddForeignKey(
                name: "FK_Crv_Reserveringen_ReserveringenId",
                table: "Crv",
                column: "ReserveringenId",
